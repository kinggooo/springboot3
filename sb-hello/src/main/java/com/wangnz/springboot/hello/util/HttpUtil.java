...
import com.wangnz.springboot.hello.http.*;
...
//        System.out.println("【APP后端请求】：" + Url + "?" + PostParms);
    ...
    public static SimpleHttpResponse doRequest(SimpleHttpClient simpleHttpclient, HttpSendModel httpSendModel, String getCharSet) throws Exception {
        ...
        simpleHttpclient.setSoTimeout(30000);
        try {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(doRequest(new HttpSendModel("https://124.74.249.15/mobilebank/B2CPayment?merchNo=301310063009501&orderNo=622938&orderDate=20140721"), "utf-8").getEntityString());
    }
